...
(
    ...
    , namespace
    , name
    , CASE WHEN name = 'pot' THEN 'DSR' --maker DSR
        WHEN name IN ('OlympusTreasury','MapleTreasury','Proxy','Proxy_v2','Treasury') THEN 'Treasury' /* potentially includes personal smart contract wallets */
...
(
    ...
    FROM maker_ethereum.DAI_evt_Transfer
    UNION ALL
    SELECT 0x197e90f9fad81970ba7976f33cbd77088e5d7cf7 AS address
...
FROM balances
WHERE dt > DATE('2020-06-01') and balance > 1e-6
