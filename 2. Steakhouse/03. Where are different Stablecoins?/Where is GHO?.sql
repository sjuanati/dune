...
(
    ...
    , evt_block_time
    FROM gho_ethereum.GhoToken_evt_Transfer
), addresses AS (
    SELECT * FROM 
    (
        VALUES
...
(
    ...
    (
        ...
        , (0x5c95d4B1C3321CF898D25949F41D50Be2dB5bc1d, 'Uniswap', 'DEX')
        , (0x464C71f6c2F760DdA6093dCB91C24c39e5d6e18c, 'Aave', 'Lending')
        , (0xe8d4D93D9728bD673b0197673a230F62255C7846, 'Aave Core Team', 'Treasury')
