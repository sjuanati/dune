...
(
    ...
    FROM tether_ethereum.Tether_USD_evt_Transfer
    UNION ALL
    SELECT 0xc6cde7c39eb2f0f0095f41570af89efc2c1ea828 AS address
    , DATE(evt_block_time) AS dt
...
(
    ...
    USING (address)
    WHERE address NOT IN (0x0000000000000000000000000000000000000000,0x5754284f345afc66a98fbb0a0afe71e0f007b949) /* burn address, tether treasury (unissued) address */
    AND address NOT IN (0x661be0562b31e9e8ddc2a7c93803005a1c71d749,0x67ab29354a70732cdc97f372be81d657ce8822cd) /* blocked addresses */    
