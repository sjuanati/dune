WITH
  addresses AS (
    ...
    UNION ALL
    SELECT
      0x47ac0fb4f2d84898e4d9e7b4dab3c24507a6d503 AS wallet,
      'Binance' AS wallet_type,
      'Binance' AS protocol
    UNION ALL
    SELECT
      0x5754284f345afc66a98fbb0a0afe71e0f007b949 AS wallet,
      'CeFi' AS wallet_type,
      'Bitfinex' AS protocol /* usdt treasury for bitfinex */
    UNION ALL
    SELECT
      0x5041ed759dd4afc3a72b8192c143f72f4724081a AS wallet,
      'CeFi' AS wallet_type,
      'OKEx' AS protocol /* no dai in there as of rn */
    UNION ALL
    SELECT
      0xd6216fc19db775df9774a6e33526131da7d19a2c AS wallet,
      'CeFi' AS wallet_type,
      'Kucoin' AS protocol
    UNION ALL
    SELECT
      0xae2d4617c862309a3d75a0ffb358c7a5009c673f AS wallet,
      'CeFi' AS wallet_type,
      'Kraken' AS protocol /* pretty much just usdc in here */
    UNION ALL
    SELECT
      0xfdb16996831753d5331ff813c29a93c76834a0ad AS wallet,
      'CeFi' AS wallet_type,
      'Huobi' AS protocol /* no dai */
    UNION ALL
    SELECT
      0xeea81c4416d71cef071224611359f6f99a4c4294 AS wallet,
      'CeFi' AS wallet_type,
      'BitMEX' AS protocol /* just usdt */
    UNION ALL
    SELECT
      0x0548f59fee79f8832c299e01dca5c76f034f558e AS wallet,
      'CeFi' AS wallet_type,
      'Unspecified OTC Firm' AS protocol
    UNION ALL
    SELECT
      0x6748f50f686bfbca6fe8ad62b22228b87f31ff2b AS wallet,
      'CeFi' AS wallet_type,
      'Huobi' AS protocol /* no dai */
    UNION ALL
    SELECT
      0xd1669ac6044269b59fa12c5822439f609ca54f41 AS wallet,
      'CeFi' AS wallet_type,
      'CoinList' AS protocol
    UNION ALL
    SELECT
      0x8d1f2ebfaccf1136db76fdd1b86f1dede2d23852 AS wallet,
      'CeFi' AS wallet_type,
      'CoinList' AS protocol
    UNION ALL
    SELECT
      0xd2c82f2e5fa236e114a81173e375a73664610998 AS wallet,
      'CeFi' AS wallet_type,
      'CoinList' AS protocol
    UNION ALL
    SELECT
      0x0000006daea1723962647b7e189d311d757fb793 AS wallet,
      'CeFi' AS wallet_type,
      'Wintermute' AS protocol /* centralized market maker that provides liquidity to both CEX and DEX */
    UNION ALL
    SELECT
      0x5a52e96bacdabb82fd05763e25335261b270efcb AS wallet,
      'Binance' AS wallet_type,
      'Binance' AS protocol
    UNION ALL
    SELECT
      0xc57ae759c085c0d23a9bbf8cd3e3d306a0acf7db AS wallet,
      'CeFi' AS wallet_type,
      'Huobi' AS protocol
    UNION ALL
    SELECT
      0xda9dfa130df4de4673b89022ee50ff26f6ea73cf AS wallet,
      'CeFi' AS wallet_type,
      'Kraken' AS protocol
    UNION ALL
    SELECT
      0xc882b111a75c0c657fc507c04fbfcd2cc984f071 AS wallet,
      'CeFi' AS wallet_type,
      'Gate.io' AS protocol
    UNION ALL
    SELECT
      0x77134cbc06cb00b66f4c7e623d5fdbf6777635ec AS wallet,
      'CeFi' AS wallet_type,
      'Bitfinex' AS protocol
    UNION ALL
    SELECT
      0xec30d02f10353f8efc9601371f56e808751f396f AS wallet,
      'CeFi' AS wallet_type,
      'Kucoin' AS protocol
    UNION ALL
    SELECT
    ...
    UNION ALL
    SELECT
      0xf89d7b9c864f589bbf53a82105107622b35eaa40 AS wallet,
      'CeFi' AS wallet_type,
      'Unknown' AS protocol
    UNION ALL
    SELECT
      0xa910f92acdaf488fa6ef02174fb86208ad7722ba AS wallet,
      'CeFi' AS wallet_type,
      'Poloniex' AS protocol
    UNION ALL
    SELECT
      0x7abe0ce388281d2acf297cb089caef3819b13448 AS wallet,
      'CeFi' AS wallet_type,
      'Unknown' AS protocol
    UNION ALL
    SELECT
      0x187c0e0aa33282096b39a33457939f1dc3ea8e0f AS wallet,
      'CeFi' AS wallet_type,
      'Coinlist' AS protocol
    UNION ALL
    SELECT
      0xcffad3200574698b78f32232aa9d63eabd290703 AS wallet,
      'CeFi' AS wallet_type,
      'Unknown' AS protocol
    UNION ALL
    SELECT
      0x2c8fbb630289363ac80705a1a61273f76fd5a161 AS wallet,
      'CeFi' AS wallet_type,
      'OKEx' AS protocol
    UNION ALL
    SELECT
      0x88bd4d3e2997371bceefe8d9386c6b5b4de60346 AS wallet,
      'CeFi' AS wallet_type,
      'Kucoin' AS protocol
    UNION ALL
    SELECT
      0xa9d1e08c7793af67e9d92fe308d5697fb81d3e43 AS wallet,
      'CeFi' AS wallet_type,
      'Coinbase' AS protocol
    UNION ALL
    SELECT
      0x8d6f396d210d385033b348bcae9e4f9ea4e045bd AS wallet,
      'CeFi' AS wallet_type,
      'Gemini' AS protocol
    UNION ALL
    SELECT
      0xb60c61dbb7456f024f9338c739b02be68e3f545c AS wallet,
      'CeFi' AS wallet_type,
      'Nexo' AS protocol
    UNION ALL
    SELECT
      0xf16e9b0d03470827a95cdfd0cb8a8a3b46969b91 AS wallet,
      'CeFi' AS wallet_type,
      'Kucoin' AS protocol
    UNION ALL
    SELECT
      0x30741289523c2e4d2a62c7d6722686d14e723851 AS wallet,
      'CeFi' AS wallet_type,
      'Unknown' AS protocol
    UNION ALL
    SELECT
      0xffec0067f5a79cff07527f63d83dd5462ccf8ba4 AS wallet,
      'CeFi' AS wallet_type,
      'Nexo' AS protocol
    UNION ALL
    SELECT
      0x9aa65464b4cfbe3dc2bdb3df412aee2b3de86687 AS wallet,
      'CeFi' AS wallet_type,
      'Unknown' AS protocol
    UNION ALL
    SELECT
      0x5c985e89dde482efe97ea9f1950ad149eb73829b AS wallet,
      'CeFi' AS wallet_type,
      'Huobi' AS protocol
  ),
    ...
    FROM
      (
        VALUES
          ...
          /* has a bridge too but separate contract */ (
          ...
          /* just for MIM, token used for bridge purposes */ (
            0xcee284f754e854890e311e3280b767f80797180d,
            'Arbitrum',
            'Bridge'
          ),
          /* no dai in this bridge */ (
          ...
          (
            0xc80573c8d53ea1bba1ed505bbb537dcd4adb9067,
            'vesper',
            'Yield Farm'
          ),
          (
          ...
          (
            0x7a6f6a048fe2dc1397aba0bf7879d3eacf371c53,
            'zeroex',
            'DEX'
          ),
          (
            0xa2033d6ba88756ce6a87584d69dc87bda9a4f889,
            'zeroex',
            'DEX'
          ),
          (
          ...
          (
            0x894d1ca4c14fa5729641c4bdc461431913422b02,
            'alpha finance zap into sushi LP',
            'DEX'
          ),
          (
            0x166a309efceedc82c501014130beadd0b3097475,
            'Someones MEV Bot',
            'MEV Bot'
          ),
          (
          ...
          (
            0x31351bf3fba544863fbff44ddc27ba880916a199,
            'fraxswap',
            'DEX'
          ),
          (
          ...
          (
            0x750bb20608601e4c44acbe774fac8f37dab67c86,
            'fraxswap',
            'DEX'
          ),
          (
          ...
          (
            0x5e8c1ad4c3d04f059d5c1a2ce4593e53be270bca,
            'fraxswap',
            'DEX'
          ),
          (
  ...
  ) /* WHERE address NOT IN (SELECT address FROM ethereum.contracts WHERE address IS NOT NULL) */,
  contracts AS (
    SELECT
      address,
      namespace,
    ...
    SELECT
      ...
      CASE
        WHEN name IN (
          ...
          'Proxy_v2',
          'Treasury'
        ) THEN 'Treasury' /* potentially includes personal smart contract wallets */
        WHEN name IN (
          'Pair',
          'Fei3Crv',
          'LiquidityPoolV4',
        ...
        WHEN name IN (
          ...
          'Lending',
          'Alchemist'
        ) THEN 'Lending' /* first 3 cover compound and its forks */
        ...
        WHEN namespace IN (
          ...
          'reserve_protocol',
          'endaoment'
        ) THEN 'Treasury' /* reserve protocol is a treasury that backs their stablecoin, kind of diff. */
        WHEN namespace IN (
          'curvefi',
          'balancer_v2',
          'saddle',
        ...
        WHEN namespace IN (
          ...
          'premia',
          'notional_v2'
        ) THEN 'Lending' /* premia is an options pool, which is a type of lending with risk (lending to allow options to be underwritten) */
  ...
  deltas AS (
    ...
    FROM
      busd_ethereum.BUSDImplementation_evt_Transfer
    UNION ALL
    SELECT
      "from" AS address,
      TRY_CAST("evt_block_time" AS DATE) AS dt,
  ...
  grouped AS (
    ...
    FROM
      deltas
      LEFT JOIN contracts_and_cefi USING (address)
    WHERE
      NOT address IN (0x0000000000000000000000000000000000000000) /* burn address */
    GROUP BY
      1,
      2
  ),
