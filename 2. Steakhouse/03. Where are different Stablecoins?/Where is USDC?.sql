...
(
    ...
    , CASE WHEN name IN ('OlympusTreasury','MapleTreasury','Proxy','Proxy_v2','Treasury') THEN 'Treasury' /* potentially includes personal smart contract wallets */
        ...
        WHEN namespace IN ('aave_v2','aave_v2','truefi','maple','euler','aave','ethichub','yield_v2','premia','notional_v2') THEN 'Lending' /* premia is an options pool, which is a type of lending with risk (lending to allow options to be underwritten) */
