...
, transfer_txs as (
    SELECT DATE(t.evt_block_time) as time, t.contract_address
        , CASE 
            ...
            WHEN t."from" = 0x1601843c5E9bC251A3272907010AFa41Fa18347E THEN -t.value -- Spark Liquidity Layer
            ELSE t.value
...
SELECT time, symbol
    ...
    , MAX(allocated_usd) AS allocated_usd
FROM (
