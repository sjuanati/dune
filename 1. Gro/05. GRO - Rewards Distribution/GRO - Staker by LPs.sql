...
WITH
    ...
    total_emitted AS (
        SELECT SUM("gro_amount") AS "gro_amount_total" FROM gro_emitted_per_pool
    ),
    total_per_pool AS (
        SELECT
            "pool_type",
            SUM("gro_amount") AS "gro_amount"
...
SELECT
    "pool_type",
    "gro_amount",
    "gro_amount" / "gro_amount_total" AS "% pool",
    "gro_amount_total"
FROM total_per_pool, total_emitted
